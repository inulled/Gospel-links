...
.textbox1 { // NOTICE: textbox1 is used by addComment() in the startpage and cannot be used for anything else due to looping logic. Use textbox2 instead
font-family: Tahoma;
font-size: 10pt;
